...
import 'package:bookbytes/models/books.dart';
...
class _CartPageState extends State<CartPage> {
  ...
  void loadUserCart() {
    ...
    http
        .get(
      Uri.parse(
          "${MyServerConfig.server}/bookbytes/php/loadcarts.php?userid=$userid"),
    )
        .then((response) {
  ...
  void deleteCart(int index) {
    http.post(Uri.parse("${MyServerConfig.server}/bookbytes/php/deletecarts.php"),
        body: {
  ...
  void updateCart(int index, int newqty, double newprice) {
    http.post(Uri.parse("${MyServerConfig.server}/bookbytes/php/updatecarts.php"),
        body: {
          "cartid": cartList[index].cartId,
